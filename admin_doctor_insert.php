...
<div class="container">
  <h2 class= "py-5">Doctors Information Insert</h2>
...
$reg= "insert into doctors(hospital,doctor,department,degree,appoint) values('$name','$doctor','$dept','$degree','$appoint')";
...
<div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="degree" placeholder="Enter Degree" name="degree" required>
      <div class="valid-feedback">Valid.</div>
      <div class="invalid-feedback">Please fill out this field.</div>
    </div>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="appoint" placeholder="Enter Appointment time" name="appoint" required>
      <div class="valid-feedback">Valid.</div>
      <div class="invalid-feedback">Please fill out this field.</div>
    </div>
